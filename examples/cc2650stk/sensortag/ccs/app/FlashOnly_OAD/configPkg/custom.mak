...
linker.cmd: package/cfg/app_ble_pem3.xdl
	$(SED) 's"^\"\(package/cfg/app_ble_pem3cfg.cmd\)\"$""\"C:/ti/simplelink/ble_sdk_2_02_04_06/examples/cc2650stk/sensortag/ccs/app/FlashOnly_OAD/configPkg/\1\""' package/cfg/app_ble_pem3.xdl > $@
